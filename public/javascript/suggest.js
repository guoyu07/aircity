        ...
        function displayItems(items) {
            ...
            if (items == '') { //热门城市遍历
                for (h in options.hot_list) {
                    html += '<li rel="' + options.hot_list[h][0] + '"><a href="#' + h + '"><span>' + options.hot_list[h][
                            0] + '</span>' + options.hot_list[h][1] + '</a></li>';
                }
                ...
                for (var i = 0; i < options.source.length; i++) { //国内城市匹配
                    ...
                    if (reg.test(options.source[i][0]) || reg.test(options.source[i][1]) || reg.test(options.source[i][
                            2]) || reg.test(options.source[i][3])) {
                        html += '<li rel="' + options.source[i][0] + '"><a href="#' + i + '"><span>' + options.source[i][
                                0] + '</span>' + options.source[i][1] + '</a></li>';
                    }
                }
                if (html == '') {
